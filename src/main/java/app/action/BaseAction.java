...
////    }
//
//    // In BaseAction — now just delegates, no logic lives here
//    public T serializeForm(Map<String, String[]> requestMap) {
//        return showroomFramework.serializeForm(requestMap, this.getType());
//    }
//
//    @SuppressWarnings("unchecked")
...
//
//        // BaseAction.doGet
//        showroomFramework.htmlForm(writer, this.getType(), req.getContextPath());
//
//        writer.println("</section>");
//
